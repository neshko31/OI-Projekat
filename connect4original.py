    ...
    for r in range(ROW_COUNT - CONNECTIONS_NEEDED + 1):
        for c in range(COLUMN_COUNT):
            if board[r][c] == piece and board[r+1][c] == piece and board[r+2][c] == piece and board[r+3][c] == piece:
                return True
    # Zatim proveravamo sporedne dijagonale (u odnosu na ispis)
    for c in range(COLUMN_COUNT - CONNECTIONS_NEEDED + 1):
        for r in range(ROW_COUNT - CONNECTIONS_NEEDED + 1):
            if board[r][c] == piece and board[r+1][c+1] == piece and board[r+2][c+2] == piece and board[r+3][c+3] == piece:
                return True
    # Konacno proveravamo glavne diagonale (u odnosu na ispis)
    for c in range(COLUMN_COUNT - CONNECTIONS_NEEDED + 1):
            ...
            ## Pitaj igraca 2 za unos
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 2):
                        label = myfont.render("Igrac 2 je pobednik!", 1, YELLOW)
                        screen.blit(label, (40,10))
                        game_over = True
